classdef SolidShell2 < handle
    ...
    methods
        function obj = SolidShell2(ngpx, ngpy, ngpz, nnoz, Mhat)
           % constructor
        ...
        function [Kout, fout] = computeLinearizedSystem(obj, ex,ey,ez,eq, D)
            ...
            Ae = zeros(obj.nDispDofs, obj.nDispDofs);
            Be = zeros(obj.nDispDofs, obj.nStrainDofs);
            Ce = zeros(obj.nDispDofs, obj.nStressDofs);
            De = zeros(obj.nStrainDofs, obj.nDispDofs);
            Ee = zeros(obj.nStrainDofs, obj.nStrainDofs);
            Fe = zeros(obj.nStressDofs  , obj.nDispDofs);
            Ge = zeros(obj.nStressDofs, obj.nStrainDofs);
            He = zeros(obj.nStressDofs  , obj.nStressDofs);
            ...
            for gp = obj.ir.gps
                ...
                P = obj.stressInterp.createNmatrix(NvecSigma, 3);
            ...
            sigmaBc = (obj.nStrainDofs+obj.nDispDofs) + [2:3:12, 35:3:obj.nStressDofs]';
